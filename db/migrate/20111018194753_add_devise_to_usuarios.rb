class AddDeviseToUsuarios < ActiveRecord::Migration
  ...
  def self.down
    ...
    # By default, we don't walast_sign_in_at      nt to make any assumption about how to roll back a migration when your
    # model already existed. current_sign_in_ip   Please edit below which fields you would like to remove in this migration.
    #raise ActiveRecord::Irrelast_sign_in_ip      versibleMigration   
  end
end
